...
int main( void )
{
    ...
    gpio_set_function(PICO_DEFAULT_WS2812_PIN, GPIO_FUNC_PWM);
    
    uint pwm_slice_num = pwm_gpio_to_slice_num(PICO_DEFAULT_WS2812_PIN);
    uint pwm_chan_num = pwm_gpio_to_channel(PICO_DEFAULT_WS2812_PIN);
